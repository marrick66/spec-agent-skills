"""Centralized in-memory skill registry."""
...
class SkillRegistry:
    ...
    Usage::
        ...
        registry.load_skill("/path/to/my-skill")
    ...
    def read_resource(
        self, skill_name: str, resource_type: str, file_path: str
    ) -> str:
    ...
    def to_system_prompt(self) -> str:
        ...
        return render_system_prompt(self.list_skills())

    def get_tools(self) -> list:
        """Create and return Strands agent tools bound to this registry.

        Returns:
            A list of three tool instances:
            - list_skills: Lists all available skill names and descriptions
            - activate_skill: Loads full instructions for a named skill
            - read_skill_resource: Reads a file from a skill's resource directories
        """
